...
_SHEET_MAP = {
    'RU': {
        ...
        'col_map': {
            ...
            'WK08 RU Plan':      'wk_plan',
            'WK08 RU Act':       'wk_act',
            'RU Gap':            'gap',
            'Prev WK GAP':       'prev_gap',
            'WOW':               'wow',
            'RU Plan BPM QTR':   'bpm_plan_qtr',
            'WK08 RU Plan BPM':  'bpm_wk_plan',
            'WK08 RU Act BPM':   'bpm_wk_act',
            'RU BPM Gap':        'bpm_gap',
    ...
    'RD': {
        ...
        'col_map': {
            ...
            'WK08 RD Plan QTD':   'wk_plan',
            'WK08 RD Act QTD':    'wk_act',
            'RD Gap':             'gap',
            'PREV WK GAP':        'prev_gap',
            'WOW':                'wow',
            'RD Plan BPM QTR':    'bpm_plan_qtr',
            'WK08 RD Plan BPM':   'bpm_wk_plan',
            'WK08 RD Act BPM':    'bpm_wk_act',
            'RD BPM Gap':         'bpm_gap',
            'PREV WEEK GAP':      'bpm_prev_gap',
            'WOW BPM':            'bpm_wow',
            'Delta Reason':       'delta_reason',
    ...
    'Netadd': {
        ...
        'col_map': {
            ...
            'WK08 Net Plan':       'wk_plan',
            'WK08 Net Act':        'wk_act',
            'Net Gap':             'gap',
            'Prev WK GAP':         'prev_gap',
            'WOW':                 'wow',
            'Net Plan BPM':        'bpm_plan_qtr',
            'WK08 Net Plan BPM':   'bpm_wk_plan',
            'WK08 Net Act BPM':    'bpm_wk_act',
            'Net BPM Gap':         'bpm_gap',
